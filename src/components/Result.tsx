      ...
      <div className="mb-6 p-4 rounded bg-emerald-50 border border-emerald-200">
        ...
        <div className="flex flex-wrap gap-4 text-sm">
          ...
          <span className="font-medium text-green-700">
            Correct: <span className="font-bold">{correctAnswers}</span>
          </span>
          <span className="font-medium text-red-700">
            Wrong: <span className="font-bold">{wrongAnswers}</span>
          </span>
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center mt-6">
          ...
          {page < totalPages - 1 ? (
            ...
            <Link to="/test">
              <button className="px-4 py-2 mx-2 bg-emerald-600 text-white font-semibold rounded-md shadow hover:bg-emerald-700 transition-colors">
                Test Again
              </button>
            </Link>
          )}
